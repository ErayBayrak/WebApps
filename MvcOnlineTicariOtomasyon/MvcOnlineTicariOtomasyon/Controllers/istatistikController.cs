...
namespace MvcOnlineTicariOtomasyon.Controllers
{
    public class istatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var deger10 = c.Uruns.Count(x => x.UrunAd == "Buzdolabi");
            ViewBag.d10 = deger10;
            var deger11 = c.Uruns.Count(x => x.UrunAd == "Laptop");
            ViewBag.d11 = deger11;
            var deger12 = c.Uruns.GroupBy(x => x.Marka).OrderByDescending(y => y.Count()).
                Select(z => z.Key).FirstOrDefault();
            ViewBag.d12 = deger12;
            var deger13 = c.Uruns.Where(a => a.UrunID == (c.SatisHarekets.GroupBy(x => x.Urunid).OrderByDescending(y => y.Count())
